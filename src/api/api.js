...
const API_KEY = 'AIzaSyD70O7BAFqg7xKywdljcCSFkRqJkAObYyA';
const signUpURL = `https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=${API_KEY}`;
const signInURL = `https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=${API_KEY}`;
const baseURL = 'https://module-13-f5a00-default-rtdb.firebaseio.com';
...
const signIn = async user => {
  ...
  try {
    ...
    refs.error.textContent = error.response.data.error.message;
    state.error = error.response.data.error.message;
